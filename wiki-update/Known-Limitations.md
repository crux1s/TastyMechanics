...
PMCC (Poor Man's Covered Call), diagonals, ratio spreads, and some exotic combinations may not be classified with the correct strategy label. **P&L totals are correct** — only the Trade Type label in the closed trades table may be wrong.
